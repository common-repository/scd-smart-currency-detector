...
<p style="font-size:18px"><img src="<?php echo $scd_free_icon; ?>"><strong>&emsp;SMART CURRENCY MANAGER </strong>.</p>
<p style="font-size:16px"> Thank you for installing our end2end SCM currency manager.</p>
...
<p style="font-size:16px"> During its use if you encounter one of the problems below: <br>
1- incompatibility with the theme <br>
2- incompatibility with the plugin <br>
3-incompatibility with a payment gateway <br>
4-problem of precision during the conversion <br>
Please contact us immediately before deactivating the plugin via support@gajelabs.com
Or by watsapp:
+4917663639750</p>
<p style="font-size:16px"> <strong style="color:red; font-weight: bold;"> SCM premium variant for WCFM </strong> extends vendor dashboard to allow each vendor to define the default currency in which the want to enter their products prices. </p> 
...
Or by watsapp:
+4917663639750</p>
<p style="font-size:16px"> <strong style="color:red; font-weight: bold;"> SCM premium variant for DOKAN </strong> extends vendor dashboard to allow each vendor to define the default currency in which the want to enter their products prices. </p> 
...
Or by watsapp:
+4917663639750</p>
<p style="font-size:16px"> <strong style="color:red; font-weight: bold;"> SCM premium variant for WCMP </strong> extends vendor dashboard to allow each vendor to define the default currency in which the want to enter their products prices. </p> 
...
Or by watsapp:
+4917663639750</p>
<p style="font-size:16px"> <strong style="color:red; font-weight: bold;"> SCM premium variant for WC-Vendor </strong> extends vendor dashboard to allow each vendor to define the default currency in which the want to enter their products prices. </p> 
...
function scd_feedback() {
	  ...
	  $subject = "SCM Standard desactivated";
...
function scd_feedback_javascript() { ?>
	 ...
	 $( window ).load(function() {
	         ...
	         document.querySelector('[data-slug="scd-smart-currency-detector"] .deactivate a').addEventListener('click', function(event){
	             ...
	             $('<div title="SCM - QUICK FEEDBACK"><div style="padding:10px;">'+
	               ...
	               '<div id="scdm_limited" style="margin-left:25px;display:none;padding:10px;border:1px dotted gray;color:#660000"><strong>If you are currently using SCM Standard version please</strong> Download for free <strong> SCM premium 14 days trial </strong> <a href="https://gajelabs.com/14-day-free-trial"><strong>here</strong></a> or get our products <a href="https://gajelabs.com/our-products/"><strong>here</strong></a> to enjoy all our features<br /><p style="font-size:15px; color:#03224c">Please give us the maketplace of your site and additional Comments</p><textarea rows = "3" cols = "80" id="scdm_colf" name = "scdm_colf" placeholder="Please write here... "></textarea></div></div>'+	                 
	...
	function plugin_activated()
	{
	  ...
	  $subject = "Smart-Currency-Manager activation";
      		 	...
      		 	function plugin_deactivated()
	{
	  ...
	  $subject = "Smart-Currency-Manager Deactivation";
