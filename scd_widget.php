...
class SCD_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'scd_widget', __('SCM Widget', 'ch_scd_woo'), array('description' => __('Lets the visitor choose their preferred currency', 'ch_scd_woo'),)
        );
    }
    ...
    public function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php __('Title:', 'ch_scd_woo'); ?></label> 
