...
jQuery(document).ready(function(){
	...
	jQuery('#scd_save_buton').click(function (e) {
        ...
        var form = '<h2>SMART CURRENCY MANAGER.</h2>\n\
<p style="font-size:18px">You are using <span style="color:red">SCM Free version</span>, all SCM currency settings as features and other currencies conversion (186 currencies) are not allowed. Download for free SCM Premium 14 days trial and install it together with SCM free version to benefit all the powerful features of currency conversion. Get SCM Premium 14 days trial <a href="https://gajelabs.com/14-day-free-trial/" target="_blank"> here. </a></p>\n\
<p style="font-size:18px">Also see our SCM products variants <a href="https://gajelabs.com/our-products/" target="_blank"> here</a>, to get a suitable SCM variant according to what you need.</p>';
